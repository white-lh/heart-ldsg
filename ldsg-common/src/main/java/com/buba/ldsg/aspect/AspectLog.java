package com.buba.ldsg.aspect;

import com.buba.ldsg.exception.BaseException;
import com.buba.ldsg.util.WebUtils;
...
public class AspectLog {
     ...
     */
    @Pointcut("@annotation(com.buba.ldsg.annotation.Log)")
    public void log(){
